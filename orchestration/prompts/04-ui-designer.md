...
- **Before handoff** — validate quality gate: `.claude/skills/quality-gate-checker/scripts/Test-QualityGate.ps1 -ProjectName "{project}" -Phase "ui-design"`
- **At handoff** — generate handoff message: `.claude/skills/orchestration-handoffs/scripts/New-Handoff.ps1 -From "UI Designer" -To "Planner" -ProjectName "{project}" -Findings "decision1","decision2"`
